    ...
    <>
          ...
          <div className="flex h-16 md:h-20 items-center justify-between">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="flex items-center focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 rounded-full">
                  <Avatar className="h-10 w-10 md:h-11 md:w-11 cursor-pointer border-2 border-border hover:border-primary transition-colors">
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 glass border-t border-border/40 pb-safe">
        <div className="flex items-center justify-around py-2 px-2">
          ...
          >
            <User className={cn('h-5 w-5', location.pathname === '/settings' && 'scale-110')} />
            <span>Profile</span>
          </Link>
        </div>
      </nav>
